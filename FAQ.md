## FAQ:
  ...
  **A:** The best way to connect is to use the list of resources available on the official 100DaysOfCode site:
  ...
  Also, here is [an invite link to the 100DaysOfCode Slack channel](https://www.100daysofcode.com/slack). - This link doesn't currenntly work so I have requested a new link (NC)
